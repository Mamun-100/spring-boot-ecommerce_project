...
public class ProductsController {
    ...
    public String getProducts(@RequestParam(name = "type", defaultValue = "Laptop") String type, Model m, HttpSession session) {
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/paymentView")
    public String paymentView() {

        return "payment";
    }

    @RequestMapping(method = RequestMethod.GET, value = "/userorderlistView")
    public String userorderlistView(Model m) {
